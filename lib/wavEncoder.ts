...
function encodeWav(buffer: AudioBuffer): Blob {
  ...
  bufferView.setUint32(offset, 16, true); offset += 4;            // Subchunk1Size
  bufferView.setUint16(offset, 1, true); offset += 2;             // AudioFormat = PCM
  bufferView.setUint16(offset, numChannels, true); offset += 2;   // NumChannels
  bufferView.setUint32(offset, sampleRate, true); offset += 4;     // SampleRate
  bufferView.setUint32(offset, byteRate, true); offset += 4;       // ByteRate
  bufferView.setUint16(offset, blockAlign, true); offset += 2;     // BlockAlign
  bufferView.setUint16(offset, bitsPerSample, true); offset += 2;  // BitsPerSample
